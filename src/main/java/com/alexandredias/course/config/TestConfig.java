package com.alexandredias.course.config;
...
import com.alexandredias.course.entities.OrderItem;
import com.alexandredias.course.entities.Payment;
import com.alexandredias.course.entities.Product;
import com.alexandredias.course.entities.User;
import com.alexandredias.course.entities.enums.OrderStatus;
import com.alexandredias.course.repositories.CategoryRepository;
import com.alexandredias.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2);//acessa a categoria do p1 e add o tipo de categoria dele
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));//salva os produtos com as associaçoes
